...
export function WorkshopPreview() {
  ...
  return (
    <section
      ref={sectionRef}
      id="workshop"
      className="themed-section relative overflow-hidden py-24 md:py-32 light-reflection"
    >
        ...
        >
          <div>
            ...
            <p
              ...
              style={{ color: tm }}
            >
              Approfondimenti pratici con i migliori specialisti del settore.
              Acquistabili singolarmente o inclusi nel tuo percorso.
            </p>
          </div>
          <Button href="/masterclass" variant="outline" size="sm">
            Vedi tutti i Masterclass →
          </Button>
        </div>
        ...
        >
          {WORKSHOPS.map((ws, i) => {
            ...
            return (
              ...
              >
                <div className="bento-card bento-card--themed relative flex h-full min-h-[160px] flex-col justify-between p-6 transition-all duration-500 group-hover:border-academy-orange/30">
                  <div className="mb-auto">
                    ...
                    {isWide && (
                      <p
                        className="mt-1.5 text-xs leading-relaxed text-academy-gray-500"
                        style={{ color: tm }}
                      >
                        {ws.focus}
                      </p>
                  ...
                  <div className="mt-4 flex items-end justify-between">
                    <span
                      className="text-[0.75rem] font-medium tracking-wider text-academy-gray-600 uppercase"
                      style={{ color: tm }}
                    >
                      {ws.duration}
                    </span>
