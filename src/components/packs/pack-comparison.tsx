...
type BlockSlug = "corpus" | "vis" | "victor";
...
function BlockModal({
  ...
  const bg = isDark ? "rgba(8,8,18,0.98)" : "rgba(248,248,252,0.99)";
  ...
  return createPortal(
    <div
      ...
      style={{
        background: isDark ? "rgba(0,0,0,0.82)" : "rgba(0,0,0,0.5)",
    ...
    >
      ...
      >
        <button
          onClick={close}
          className="absolute right-5 top-5 z-10 text-[0.68rem] font-bold tracking-[0.22em] uppercase transition-opacity hover:opacity-60"
          style={{ color: ts }}
        >
          Chiudi ×
        </button>
        ...
        <div className="p-7 md:p-10">
          ...
          <div className="mb-8 flex items-start gap-5">
            <div
              className="shrink-0 flex items-center justify-center text-xs font-black"
              style={{
                width: "44px",
                height: "44px",
                border: `1px solid ${cellBorder}`,
            ...
            <div>
              <div
                className="text-[0.6rem] font-black tracking-[0.38em] uppercase mb-1"
                style={{ color: ts }}
              >
                Blocco Formativo
              </div>
              <h2
                className="text-[clamp(2rem,4vw,3rem)] font-black leading-none tracking-tight"
                style={{ color: th }}
              >
                {course.title}
              </h2>
              <div
                className="mt-2 text-[0.7rem] font-bold tracking-[0.22em] uppercase"
                style={{
                  color: isDark
                    ? "rgba(240,146,38,0.6)"
                    : "rgba(180,80,0,0.65)",
          ...
          <div className="grid gap-3 md:grid-cols-12">
            {/* Objective */}
            <div
              className="md:col-span-12 p-5"
              style={{ background: cellBg, border: `1px solid ${cellBorder}` }}
            >
              <div
                className="text-[0.56rem] font-black tracking-[0.35em] uppercase mb-2"
                style={{ color: ts }}
              >
                Obiettivo
              </div>
            ...
            {/* Curriculum */}
            <div
              className="md:col-span-7 p-5"
              style={{ background: cellBg, border: `1px solid ${cellBorder}` }}
            >
              <div
                className="text-[0.56rem] font-black tracking-[0.35em] uppercase mb-4"
                style={{ color: ts }}
              >
                Programma
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {course.curriculum.map((item, i) => (
                  ...
                  >
                    <span
                      className="shrink-0 text-[0.5rem] font-black tracking-wider tabular-nums mt-[3px]"
                      style={{
                        color: isDark
            ...
            <div className="md:col-span-5 flex flex-col gap-3">
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  >
                    ...
                    <span
                      className="mt-1 text-[0.55rem] font-bold tracking-[0.18em] uppercase"
                      style={{ color: ts }}
                    >
                      {s.label}
                    </span>
              ...
              >
                <div
                  className="text-[0.56rem] font-black tracking-[0.35em] uppercase mb-3"
                  style={{ color: ts }}
                >
                  Weekend 2026/27
                </div>
                <div className="flex flex-wrap gap-2">
                  {course.dates.map((d) => (
                    <span
                      key={d}
                      className="px-3 py-1.5 text-[0.72rem] font-semibold"
                      style={{ border: `1px solid ${cellBorder}`, color: tb }}
                    >
                      {d}
                    </span>
                  ))}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {teachers.map((t) => (
                  ...
                  >
                    <div
                      className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[0.65rem] font-black overflow-hidden"
                      style={{
                        background: isDark
            ...
            {/* Masterclass note */}
            <div
              className="md:col-span-12 flex items-start gap-4 p-5"
              style={{
