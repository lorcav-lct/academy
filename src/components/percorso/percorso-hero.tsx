...
function VideoBlock({ isDark }: { isDark: boolean }) {
  ...
  // ── Control bar: [FS | sep | ⏪10 | Play | Volume ] + seek row ──────────────
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Seek input — custom progress fill via CSS gradient */}
          <div className="relative flex-1 h-3 flex items-center group/seek">
            <div
            ...
            {coursesSorted.map((course, i) => (
              ...
              >
                <button
                  ...
                  className="group flex flex-col justify-between h-full w-full text-left p-6 md:p-7 focus-visible:outline-none"
                ...
                {MONTH_ABBRS.map((m, i) => (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        color: isDark ? "rgba(142,142,147,0.6)" : "#bbb",
                      }}
                    >
                      {m}
                    </span>
