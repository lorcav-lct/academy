...
function HeroSection({
  ...
  return (
    <section
      ref={sectionRef}
      className="themed-section relative flex min-h-[88vh] items-center overflow-hidden pt-24"
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at 72% 50%, rgba(${ORANGE_RGB},0.06) 0%, transparent 55%)`,
        }}
      />
