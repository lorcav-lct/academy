...
export const TEACHERS: Teacher[] = [
  ...
  },
  {
    ...
    courses: ["function"],
    image_url: "/docenti/claudio-pecorella.webp",
    color: BRAND,
    talkTitle:
  ...
  {
    slug: "leandro-mosconi",
    name: "Leandro Mosconi",
    role: "Preparatore Atletico — Daniil Medvedev",
    bio: "Preparatore atletico di Daniil Medvedev, tennista professionista del circuito ATP.",
    courses: ["master-tennis"],
    image_url: "/docenti/leandro-mosconi.webp",
    color: BRAND,
    talkTitle: "Performance e Preparazione Atletica nel Tennis di Alto Livello",
  },
  {
    slug: "dragoljub-kladarin",
    name: "Dragoljub Kladarin",
    role: "Preparatore Atletico — Alejandro Davidovich Fokina",
    bio: "Preparatore atletico di Alejandro Davidovich Fokina, tennista professionista del circuito ATP.",
    courses: ["master-tennis"],
    image_url: "/docenti/dragoljub-kladarin.webp",
    color: BRAND,
    talkTitle: "Performance e Preparazione Atletica nel Tennis di Alto Livello",
  },
  {
