...
export const WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    duration: "1-2 giornate",
    date: "Da definire",
    teacherSlugs: ["andrea-quarto", "emanuela-romano"],
    trainerLabel: "Andrea Quarto + Emanuela Romano",
    sortOrder: 2,
  },
  {
    slug: "master-calcio",
    ...
    duration: "1-2 giornate",
    date: "Da definire",
    teacherSlugs: ["mino-fulco"],
    trainerLabel: "Mino Fulco",
    sortOrder: 3,
  },
  {
    slug: "master-volley",
  ...
  },
  {
    ...
    duration: "1-2 giornate",
    date: "Da definire",
    teacherSlugs: ["giovanni-benzon"],
    trainerLabel: "Giovanni Benzon",
    sortOrder: 5,
  },
  {
    slug: "master-rugby",
  ...
  },
  {
    ...
    date: "Da definire",
    teacherSlugs: ["fitri"],
    trainerLabel: "Fitri — Running Club Parma",
    sortOrder: 7,
  },
  {
    ...
    focus: "Preparazione fisica e atletica per sport da combattimento e arti marziali",
    duration: "1-2 giornate",
    date: "Da definire",
    teacherSlugs: [],
    trainerLabel: "Da definire",
